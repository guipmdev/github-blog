...
<p align="center">
  <img
    src="https://img.shields.io/github/languages/count/guipmdev/github-blog?color=%2304D361&labelColor=202024&label=linguagens"
    alt="Contagem de linguagens do repositório"
  />
  <img
    src="https://img.shields.io/github/repo-size/guipmdev/github-blog?labelColor=202024&label=tamanho do repo"
    alt="Tamanho do repositório"
  />
  <img
    src="https://img.shields.io/github/commit-activity/m/guipmdev/github-blog?color=black&labelColor=202024&label=atividade de commits"
  ...
  >
    <img
      src="https://img.shields.io/github/last-commit/guipmdev/github-blog?labelColor=202024&label=último commit"
      alt="Último commit"
    />
  </a>
...
Esse projeto é uma aplicação web desenvolvida em _React_ que oferece uma interface de leitura e pesquisa de publicações em repositórios do GitHub. Suas principais funcionalidades incluem visualizar as informações básicas de um usuário específico na página inicial, buscar por postagens usando palavras-chave e/ou filtros de repositórios e fazer sua leitura por completo ao acessá-las.

Seu objetivo principal é fornecer uma aplicação fácil de usar e visualmente agradável para navegação e exploração dos blogs, melhorando sua experiência de leitura e descoberta de conteúdos.
